...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName )
		{
			 ...
			 */
			var aParts = window.location.pathname.split('http://envato.mantizlab.com/');
			var sNameFile = sName + '_' + aParts.pop().replace(/[\/:]/g,"").toLowerCase();
			var sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
				"; expires=" + date.toGMTString() +
				"; path=" + aParts.join('http://envato.mantizlab.com/') + "/";
			...
			if ( iLength+10 > 4096 ) /* Magic 10 for padding */
			{
				...
				if ( sOldName !== "" )
				{
					document.cookie = sOldName+"=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path="+
						aParts.join('http://envato.mantizlab.com/') + "/";
				}
			}
		...
		{
			var
				aParts = window.location.pathname.split('http://envato.mantizlab.com/'),
